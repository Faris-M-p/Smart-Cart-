...
GO
/**********************************************************************
Stored Procedure : AdminCancelOrder
Created By       : Muhammed Faris
Created On       : 08/09/2026

PURPOSE
  Soft-cancel a placed or confirmed order and restore stock.
**********************************************************************/
CREATE OR ALTER PROCEDURE [dbo].[AdminCancelOrder]
(
    @OrderId INT,
...
BEGIN
    ...
    BEGIN
        SET @CancelReason = N'Cancelled by admin';
    END
    ...
    IF @OrderStatus NOT IN (N'Placed', N'Pending', N'Confirmed')
    BEGIN
