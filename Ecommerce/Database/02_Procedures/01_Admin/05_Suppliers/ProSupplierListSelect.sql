...
**********************************************************************/
CREATE OR ALTER PROCEDURE [dbo].[ProSupplierListSelect]
(
...
BEGIN
    ...
    BEGIN
        SET @SqlStr += ' ORDER BY ' +
            CASE 
                WHEN @SortColumn = 'SupplierName' THEN 's.Name'
                WHEN @SortColumn = 'CreatedOn' THEN 's.CreatedAt'
